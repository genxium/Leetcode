If a reader is new to this problem/topic, the "iterative approach" is strongly recommended for reading because it provides more insights into the "closure state caching".
