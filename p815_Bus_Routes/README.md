Note that in this problem, the number of possible `routes` are significantly smaller than that of `stops`. Therefore using `adjRoutes` is a faster option than `adjStops` in both solutions.
